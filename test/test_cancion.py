...
class TestCancionObtenerCaratula(unittest.TestCase):
    ...
    def test_obtener_caratula_formato_bytes(self):
        resultado = self.cancion_con_caratula.obtener_caratula_general_cancion(formato="bytes")
    ...
    def test_obtener_caratula_formato_pil(self):
        resultado = self.cancion_con_caratula.obtener_caratula_general_cancion(formato="PIL")
    ...
    def test_obtener_caratula_redimensionar_ancho(self):
        ancho_deseado = 50
        resultado = self.cancion_con_caratula.obtener_caratula_general_cancion(formato="PIL", ancho=ancho_deseado)
    ...
    def test_obtener_caratula_redimensionar_alto(self):
        alto_deseado = 50
        resultado = self.cancion_con_caratula.obtener_caratula_general_cancion(formato="PIL", alto=alto_deseado)
    ...
    def test_obtener_caratula_redimensionar_ambos(self):
        ancho_deseado = 75
        alto_deseado = 50
        resultado = self.cancion_con_caratula.obtener_caratula_general_cancion(
    ...
    def test_obtener_caratula_formato_invalido(self):
        with self.assertRaises(ValueError):
            self.cancion_con_caratula.obtener_caratula_general_cancion(formato="formato_inexistente")

    def test_obtener_caratula_sin_caratula(self):
        resultado = self.cancion_sin_caratula.obtener_caratula_general_cancion()
